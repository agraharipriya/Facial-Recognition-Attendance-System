...
path = r'C:\Users\Priya Agrahari\OneDrive\Desktop\Final year\ImagesAttendances'
images = []
classNames = []
...
def markAttendance(name):
    with open(
            r'C:\Users\Priya Agrahari\OneDrive\Desktop\Final year\Attendance.csv',
            'r+') as f:
...
while True:
    ...
    for encodeFace, faceLoc in zip(encodeCurFrame, facesCurFrame):
        ...
        if matches[matchIndex]:
            ...
            markAttendance(name)
            d = {'rollNo': roll_No, 'classYr': year, 'stdName': name, 'attDate': dtstring1, 'attTime': dtstring,
                 'createdDate': dtstring1, 'attHr': attHr}
